...
<div class="row" style="margin-bottom: 0px;">
    ...
    <div class="col l8 center">
		<div class="row">
			<h5 id="common_lable" class="green-text text-darken-2" style="font-weight:600">ASSET MANAGEMENT</h5>
    ...
    <div class="col l2 valign-wrapper" style="height: 118px; width:214px; line-height:25px">      	
		<div class="row valign valign-wrapper logout_div">			
			<a id="nlmis_btn" href="#" title="N-LMIS">
				<img src="resources/images/NLMIS.png" alt="" onclick="goToNLMIS()">
			</a>&nbsp;&nbsp;		
