 ...
 */
@Controller
public class LgaCapacityController {
    ...
    @RequestMapping(value = "/lgacapacity", method = RequestMethod.GET)
    public ModelAndView showFunctionChart(HttpServletRequest request, HttpServletResponse respones) {
        ModelAndView modelAndView = new ModelAndView("LgaCapacity");
        try {
    ...
    @RequestMapping(value = "/get_lga_capacity_data")
    public JSONArray getLGACapacityData(HttpServletRequest request, HttpServletResponse respones, @RequestParam("filterLevel") String filterLevel) {
...
//		System.out.println("week :" + week);
        try {
            ...
            data = new AMSChartServices().getLGACapacityData(userBean, sclevel);

            System.out.println("get_lga_capacity_data jsonforjsp ======" + data.toString());
