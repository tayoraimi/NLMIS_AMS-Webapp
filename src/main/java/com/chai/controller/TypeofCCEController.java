 ...
 */
@Controller
public class TypeofCCEController {
    ...
    @RequestMapping(value = "/typeofcce", method = RequestMethod.GET)
    public ModelAndView showFunctionChart(HttpServletRequest request, HttpServletResponse respones) {
		ModelAndView modelAndView= new ModelAndView("TypeOfCCE");
		try {
    ...
    @RequestMapping(value = "/get_type_of_cce_data")
...
//		System.out.println("week :" + week);
        try {
            ...
            data = new AMSChartServices().getTypeOfCCEData(userBean, sclevel);

            System.out.println("get_type_of_cce_data jsonforjsp ======" + data.toString());
